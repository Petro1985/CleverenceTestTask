...
public class FirstImplementationTest
{
    ...
    [Fact]
    public async Task Server_Must_Allow_To_Read_and_Write_Without_Race_Condition()
    {
        ...
        Assert.Equal(Server.GetCount(), _writeCount.Sum());
    }
